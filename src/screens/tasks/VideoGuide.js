    ...
    <div class="screen">
      ...
      <div style="padding: var(--space-4); padding-bottom: var(--space-32);">
        ...
        <div style="text-align: center; margin-bottom: var(--space-6);">
          <div style="width: 120px; height: 120px; border-radius: var(--radius-full); background: linear-gradient(135deg, var(--secondary-100), var(--accent-50)); display: flex; align-items: center; justify-content: center; margin: 0 auto; font-size: 56px; animation: bounceIn 0.6s cubic-bezier(0.34, 1.56, 0.64, 1);">
            🎥
          </div>
        ...
        <div style="display: flex; flex-direction: column; gap: var(--space-3);">
          <button class="btn btn-primary btn-full btn-lg" id="recordBtn">
            🎥 ${t('tasks.record_video')}
          </button>
