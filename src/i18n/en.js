...
Return JSON:
{
  ...
  landing: {
    ...
    open_app: 'Open App',
    kicker: 'A calmer, more organized pet health experience',
    hero_title: 'Clarify the signs, organize the record, arrive prepared.',
    hero_desc: 'Pet Help brings pet profiles, health history, pre-check flow, safe guidance and post-treatment follow-up into one place. The goal is not diagnosis; it is less chaos when decisions matter.',
    hero_primary: 'Explore the admin panel',
    hero_secondary: 'Open the mobile experience',
    ...
    preview_meta: 'Records · pre-assessment · follow-up',
    ...
    story_title: 'Less uncertainty in stressful moments, better records, clearer communication.',
    story_desc: 'Most owners do not know what matters, what to note down, or how to explain the case to the vet. Pet Help turns that gap into a useful record flow.',
    ...
    features_title: 'The mobile app does more than note-taking; it organizes messy moments.',
    features_desc: 'The core health archive and the AI-assisted pre-check flow work together in one experience. Users record, track and share inside one product system.',
    features: [
      { title: 'Smart pre-check', desc: 'Starts from the main complaint and narrows into relevant questions instead of pushing users through bloated flows.' },
      { title: 'Health passport', desc: 'Vaccines, parasite care, measurements, documents, expenses and free-form records stay in one pet file.' },
      { title: 'Red-flag logic', desc: 'Separates urgent risks, keeps the language controlled and pushes the user toward the right next step.' },
      { title: 'Media and document archive', desc: 'Photos, videos, prescriptions, lab files and shareable report links stay organized.' },
      ...
      { title: 'Family and care sharing', desc: 'Multiple pets, different caregivers and shared record structure run on the same foundation.' }
    ],
    ...
    audience_title: 'Built for real care networks, not just a single-user checklist.',
    ...
    proof: ['Record-first structure', 'Shareable report links', 'Post-treatment follow-up flow'],
    metrics: [
    ...
    cta_title: 'A better health record is often more valuable than a faster note.',
