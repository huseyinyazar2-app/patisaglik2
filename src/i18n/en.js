...
const en = {
  ...
  auth: {
    ...
    email: 'Email', phone_or_email: 'Phone or email', phone_or_email_placeholder: '+90 5xx xxx xx xx or email', password: 'Password', password_confirm: 'Confirm Password', fullname: 'Full Name',
  ...
  home: {
    ...
    vet_live_entry: 'Live Vet Consultation',
    ...
    no_credit: 'First AI credit included',
  ...
  qualityCheck: {
    analyzing: 'Checking quality',
    analyzing_desc: 'Light, sharpness and resolution are being checked quickly.',
    video_analyzing_desc: 'Duration, resolution and first-frame lighting are being checked quickly.',
    manual_check: 'Manual check needed',
    manual_check_desc: 'Automatic quality check could not finish. You can use the record if the pet is clearly visible.',
    score: 'Quality score: {score}/100',
    before_photo_title: 'Capture check',
    before_photo_desc: 'Improve lighting, keep the pet in frame, hold the phone steady and capture the target area without cutting it off.',
    before_video_title: 'Video guide',
    before_video_desc: 'Keep the full pet in frame, hold steady, record at least 6-10 seconds and do not cover the walking/breathing area.',
    good_photo: 'The photo looks usable for the vet report.',
    good_video: 'The video looks usable for the vet report.',
    photo_meta: '{width}x{height} · light {brightness}',
    video_meta: '{width}x{height} · {duration} sec',
    levels: {
      good: 'Record looks good',
      watch: 'Usable, but check it',
      poor: 'Retaking would be better'
    },
    issues: {
      low_resolution: 'Resolution is low; try a clearer or closer capture.',
      too_dark: 'Lighting is low; try a brighter place.',
      too_bright: 'Image is too bright; reduce direct light.',
      low_contrast: 'The pet or target area does not stand out clearly from the background.',
      blurry: 'Image is blurry; hold the phone steady and retake.',
      too_short: 'Video is too short; a 6-10 second clip is more useful.'
    }
  },
  summary: {
  ...
  admin: {
    ...
    login_title: 'Pet Help Management',
  ...
  featureForm: {
    ...
    paid_info: 'This area will open with a post-store update. Record archive, expenses, reminders, QR card and tracking forms remain available.',
    view_plans: 'View Plans',
    store_update_later: 'Opens after store release',
    ...
    sitter_invite_ready: 'Pet Help sitter invitation is ready.',
    sitter_invite_title: 'Pet Help Sitter Invitation',
  ...
  common: {
    ...
    detail: {
      ...
      no_size: 'No size',
      open: 'Open',
      reminder_ics_title: 'Pet Help Reminder',
      reminder_ics_desc: 'Pet Help reminder',
    ...
    submissions: {
      ...
      invite_text: '{name} caregiver invite is ready in Pet Help. Duration: {duration}. Permissions: {permissions}.',
      expense_other: 'Other',
...
Return JSON:
{
  ...
  volunteerNetwork: {
    ...
    share_title: 'Pet Help Volunteer Location',
  ...
  publicPetCard: {
    ...
    share_title: 'Pet Help Emergency Card',
  ...
  publicVetReport: {
    ...
    share_title: 'Pet Help case report',
  ...
  landing: {
    ...
    language: 'Language',
    open_app: 'Open App',
    kicker: 'More organized, safer pet health follow-up',
    hero_title: 'Know what to do in stressful moments, and arrive at the vet with the right information.',
    hero_desc: 'Pet Help brings the pet health passport, smart pre-check, record archive, shareable vet report and post-treatment follow-up into one calm experience. It does not diagnose; it helps owners organize the right information and act faster when risk matters.',
    hero_primary: 'Create a free account',
    hero_secondary: 'How it works',
    mobile_preview: 'Mobile Preview',
    visual_label: 'Pet Help showcase scene',
    free_health_area: 'Free health area',
    pre_check: 'Pre-check',
    preview_subject: 'Live health file',
    preview_meta: 'Health history · pre-check · follow-up',
    preview_passport: 'Shareable file',
    preview_weight: 'Weight',
    preview_followup: 'Follow-up',
    preview_single_flow: 'One flow',
    risk_signal: 'Risk signal',
    vet_guidance_ready: 'Vet-ready summary',
    visual_floating_top: 'Health passport',
    visual_floating_top_title: 'Vaccines, measurements, documents and costs together',
    visual_floating_top_desc: 'A structured archive instead of scattered screens',
    visual_floating_bottom: 'Follow-up plan',
    visual_floating_bottom_title: 'Medication, check-ins and signs in one plan',
    visual_floating_bottom_desc: 'A post-treatment flow that does not fall apart',
    visual_side_one: 'Pre-assessment',
    visual_side_one_title: 'The complaint narrows fast',
    visual_side_one_desc: 'Relevant questions open and unnecessary cards stay out.',
    visual_side_two: 'Clinic prep',
    visual_side_two_title: 'Report link ready',
    visual_side_two_desc: 'A concise shareable summary before the visit.',
    story_kicker: 'One purpose',
    story_title: 'What owners really need is not diagnosis; it is order, follow-up and the right action at the right time.',
    story_desc: 'Vomiting, diarrhea, limping, skin issues or suspected poisoning can scatter information fast. Pet Help gathers signs, history, media and documents in one flow so the vet conversation starts with better context.',
    story_badge_title: 'Not home diagnosis, but organized decision support',
    story_badge_desc: 'Language stays controlled in risky areas; records, observations and timeline stay at the center.',
    features_kicker: 'Core product',
    features_title: 'Health history, pre-check and follow-up in one place.',
    features_desc: 'Pet Help turns everyday records into a meaningful health file that can support a clinic conversation. It scales from free basic tracking to AI-assisted report flows.',
    features: [
      { title: 'Pet health passport', desc: 'Vaccines, parasite care, measurements, documents, expenses, chronic notes and media history stay in one pet file.' },
      { title: 'Smart pre-check', desc: 'The flow starts from the main complaint and narrows into relevant questions, reducing unnecessary question overload.' },
      { title: 'Urgency awareness', desc: 'Red flags are separated, safety limits stay clear and risky cases are guided toward veterinary support.' },
      { title: 'Vet-ready link', desc: 'Complaint summary, timeline, media and documents are gathered into a shareable report link.' },
      { title: 'Post-treatment follow-up', desc: 'Medication times, sign changes, wound checks and revisit planning stay in one trackable plan.' },
      { title: 'Multi-pet and family use', desc: 'Multiple pets, different caregivers and permission-based sharing run on the same foundation.' }
    ],
    journey_kicker: 'How it works',
    journey_title: 'It moves step by step instead of overwhelming the user with data.',
    journey_desc: 'The flow captures the main issue first, then requests only relevant evidence, and ends with a clear shareable output plus a follow-up plan.',
    journey: [
      { title: 'Clarify the complaint', desc: 'The user selects the main issue. The system trims unrelated branches and opens only the relevant question cards.' },
      { title: 'Collect the needed record', desc: 'Photos, videos, documents, measurements or a short history are added only when they are useful.' },
      { title: 'Move forward with a ready file', desc: 'The result becomes an internal record, a shareable vet link and a post-treatment follow-up path.' }
    ],
    audience_kicker: 'Who it is for',
    audience_title: 'Built for real care routines, not just a single-user checklist.',
    audience_desc: 'It scales from one owner with one pet to families managing several profiles and care routines that require consistent follow-up.',
    audiences: [
      { title: 'Pet owners', desc: 'People who want a cleaner way to react to symptoms, preserve history and keep follow-up under control.' },
      { title: 'Families and caregivers', desc: 'More than one person can work around the same pet through shared records, notes and access rules.' },
      { title: 'Pre-clinic communication', desc: 'Without trying to replace clinic software, it creates a cleaner case summary before the veterinary visit.' }
    ],
    safety_kicker: 'Safe boundaries',
    safety_title: 'Strong language, clear limits.',
    safety_desc: 'The product is designed to improve records, urgency awareness and sharing quality without pushing users toward risky at-home interventions.',
    safety_points: [
      'It uses safe guidance instead of giving home diagnosis or medication-dose advice.',
      'In red-flag, toxic exposure and foreign-body scenarios, the language stays controlled.',
      'Documents, media and follow-up records remain available as a structured archive for later review.'
    ],
    proof: ['Not a vet replacement', 'Shareable report link', 'Ready for 20+ languages'],
    metrics: [
      { value: '1 file', label: 'Pet health history' },
      { value: '20+ languages', label: 'Global launch foundation' },
      { value: 'Multi-pet', label: 'Family-scale use' }
    ],
    cta_kicker: 'Starting point',
    cta_title: 'When a pet health record is organized today, difficult moments become easier to explain.',
    cta_desc: 'Pet Help turns scattered note-taking into a health experience that is structured, shareable and easier to follow.'
  },
  reportCreate: {
  ...
  privacyScreen: {
    ...
    health_desc: 'Health records stay on the device first; areas that need sharing or sync are processed through the secure API.',
    media_desc: 'Photos, videos and audio records stay on the device by default; permitted upload is used only when reports or AI analysis need it.',
    ...
    legal_title: 'Legal and health boundaries',
    terms_title: 'Terms of use',
    terms_desc: 'The app is used for record keeping, follow-up and preparing for veterinary conversations; users are responsible for the accuracy of the information they enter.',
    health_disclaimer_title: 'Not a veterinary replacement',
    health_disclaimer_desc: 'AI or information screens are not diagnosis, treatment, medication or dosage advice. Urgent signs, suspected poisoning or worsening require veterinary support.',
    payment_policy_title: 'Payment status',
    payment_policy_desc: 'Payments and subscriptions are disabled in the first store release. New accounts receive 1 AI credit; credit adjustments are handled only from the admin panel.',
    ...
    remove_account_message: 'Account session and all Pet Help data on this device will be deleted.',
  ...
  basicKit: {
    ...
    required_desc: 'This task requires the Pet Help Basic Kit hardware. If you have the device, you can activate it from settings.',
  ...
  planScreen: {
    ...
    title: 'Plans',
    desc: 'Payment areas are disabled for the first store release.',
    packages: 'Disabled packages',
    test_note: 'Plan switching is closed for the first store release.',
    store_note: 'Purchases will open in a later store update.',
    credit_packages: 'Disabled credit area',
    buy_in_store: 'Disabled',
    insufficient_credits: 'You do not have enough credits for this AI action.',
    load_failed: 'Plan information could not be loaded: {error}',
    paused_title: 'Plans',
    paused_heading: 'Payments and subscriptions are temporarily disabled',
    paused_desc: 'The first store release will be usable without payment. Subscription, credit and store purchase areas will be activated in a later update.',
    paused_note: 'This screen was not deleted; it will be reopened when store validation is ready.'
  },
  billingPlans: {
    free: 'Free',
  ...
  notificationService: {
    ...
    reminder_title: 'Pet Help Reminder',
  ...
  devicesScreen: {
    ...
    buy_kit_paused: 'Basic Kit opens after store release',
    last_test_ready: 'Last test: {value} · Native pairing ready'
  },
  petProfiles: {
    open_map: 'Open Map',
    share_location: 'Share Location',
    share_title: 'Pet Help Location Share',
    location_copied: 'Location link copied.',
    location_copy_failed: 'Location link could not be copied. You can open the map link and share it.'
  },
  sitterInvite: {
  ...
  vetReadyDefaults: {
    ...
    media_excluded: '{count} media record(s) were excluded from the report because they were marked low quality or irrelevant.'
  },
  main: {
  ...
  vetLive: {
    title: 'Live Vet Consultation',
    kicker: 'Separate vet module',
    home_title: 'Live veterinary consultation flow',
    home_desc: 'If an active vet is available, you can start a consultation request right away for {name}.',
    book_cta: 'Request Consultation',
    quick_start_cta: 'Start Live Consultation',
    schedule_later_cta: 'Request a Later Time',
    my_bookings: 'My Consultations',
    quick_title: 'Quick live consultation',
    quick_desc: 'Write a short summary, choose an active vet and enter the consultation room. The vet joins from their panel.',
    quick_summary_placeholder: 'Briefly describe what happened. Example: Vomited twice today, appetite is lower, seems tired.',
    active_now: 'Active',
    general_consultation: 'General consultation',
    flow_title: 'Flow',
    flow_ai: { title: 'Case summary', desc: 'The owner prepares the concern and red flags.' },
    flow_booking: { title: 'Booking', desc: 'Approved vet and time stay in separate vet tables.' },
    flow_room: { title: 'Room', desc: 'Daily room/token work is handled only by the vet-live API.' },
    flow_note: { title: 'Note', desc: 'The vet outcome is saved separately and copied into the health archive.' },
    recent_title: 'Recent consultations',
    vet_panel: 'Vet Panel',
    book_kicker: 'Later-time request',
    book_title: 'Create consultation request',
    book_desc: 'Write a short case summary for {name} and choose an available vet.',
    vet_label: 'Veterinarian',
    first_available_vet: 'First available vet / request pool',
    no_active_vets: 'No vets are active right now; the request can still enter the pool.',
    schedule_label: 'Appointment time',
    case_summary_label: 'Case summary',
    case_summary_placeholder: 'Write signs, duration, appetite, behavior and any pre-check result.',
    red_flags_label: 'Red flags',
    red_flags_placeholder: 'One risk per line. Example: trouble breathing, repeated vomiting.',
    disclaimer: 'This is remote consultation and guidance, not diagnosis or treatment. Emergency cases should not wait for the app.',
    duration_warning: 'Consultation duration is 15 minutes. Extra credits may be charged for sessions over 15 minutes in the future; no extra credit is charged now.',
    legal_consent_label: 'I accept that 8 credits will be held before the consultation, that there is no cancel/refund after the consultation starts, and that this service does not replace emergency clinical examination.',
    legal_consent_required: 'You must accept the credit and consultation terms before creating a booking.',
    create_booking: 'Create Consultation Request',
    not_scheduled: 'No time selected',
    default_vet: 'Approved veterinarian',
    active_pet: 'Active pet',
    empty_case_summary: 'No case summary was written.',
    mark_paid: 'Manual payment approval',
    credit_hold_label: 'Credit status',
    cancel_booking: 'Cancel Consultation and Refund Credit',
    join_room: 'Start Live Consultation',
    start_consultation: 'Start Live Consultation',
    note_title: 'Veterinary note',
    no_note: 'No veterinary note has been added yet.',
    room_kicker: 'Daily Prebuilt',
    room_title: 'Consultation room',
    room_desc: 'When camera and microphone permission is granted, the consultation opens here.',
    room_ready: 'Consultation ready',
    daily_ready: 'Consultation link is ready. You can talk when the vet also joins.',
    local_room_notice: 'No Daily API key is configured; a local/mock room link is shown for the pilot.',
    permission_denied: 'Camera or microphone permission was denied',
    open_room: 'Open Consultation in New Tab',
    room_failed: 'Could not prepare the consultation link',
    retry_later: 'Check the network connection or permissions and try again.',
    vet_panel_title: 'Waiting live consultations',
    vet_panel_desc: 'Claim owner requests, join the consultation and write the required end-of-call note here.',
    note_form_title: 'End-of-consultation record',
    note_form_desc: 'This note is required after the consultation and is saved into the pet health summary.',
    booking_id_label: 'Selected consultation',
    booking_id_placeholder: 'Select a consultation above',
    note_summary_label: 'General assessment',
    note_summary_placeholder: 'What was discussed, what is the general status, what did you recommend?',
    next_step_label: 'Recommended next step',
    next_step_placeholder: 'Example: monitor for 24 hours, clinic exam, follow-up consultation...',
    clinic_visit_recommended: 'Clinic visit recommended',
    save_note: 'Save Note',
    health_record_title: 'Live vet consultation',
    no_bookings: 'No consultations',
    no_bookings_desc: 'You can create the first live vet appointment from this area.',
    no_queue: 'No waiting consultations',
    no_queue_desc: 'Bookings will appear in the vet panel after they are created.',
    load_failed: 'Could not load consultation data.',
    lookup_ready: 'Approved vets are ready.',
    lookup_failed: 'Could not load vet list.',
    quote_text: '{duration} min · {price}',
    credit_price: '{count} credits',
    quote_failed: 'Could not load price information.',
    summary_required: 'Case summary is required.',
    booking_created: 'Consultation booking was created.',
    booking_failed: 'Could not create booking. {error}',
    booking_not_found: 'Consultation not found.',
    payment_marked: 'Payment was manually approved.',
    payment_failed: 'Payment could not be approved.',
    insufficient_credits: 'There are not enough credits for this consultation.',
    booking_cancelled: 'Consultation was cancelled and the held credit was refunded.',
    cancel_failed: 'Cancel/refund could not be completed. {error}',
    owner_survey_title: 'Veterinarian feedback',
    vet_survey_title: 'Owner consultation feedback',
    survey_rating_label: 'Rating',
    owner_survey_feedback: 'Were you satisfied with the veterinarian?',
    vet_survey_feedback: 'Was the owner clear and appropriate during the consultation?',
    save_survey: 'Save Survey',
    survey_saved: 'Survey saved.',
    survey_failed: 'Could not save survey. {error}',
    note_required: 'Consultation ID and note are required.',
    note_saved: 'Veterinary note was saved.',
    note_failed: 'Could not save note. {error}',
    pool_request: 'Pool request',
    pool_request_desc: 'You can still create the request; an active vet can claim it from the panel.',
    claim_booking: 'Assign to Me',
    claim_saved: 'Request was assigned to your vet account.',
    claim_failed: 'Could not claim request. {error}',
    select_for_note: 'Write Note for This',
    open_detail: 'Consultation Info',
    tab_active: 'Active',
    tab_scheduled: 'Scheduled',
    tab_history: 'History',
    tab_profile: 'Profile',
    refresh: 'Refresh',
    active_requests_title: 'Active live requests',
    scheduled_requests_title: 'Scheduled requests',
    history_title: 'Past consultations',
    no_active_requests: 'No active requests',
    no_active_requests_desc: 'Immediate and pool requests appear here.',
    no_scheduled_requests: 'No scheduled requests',
    no_scheduled_requests_desc: 'Later-time requests are listed here.',
    no_history: 'No past consultations',
    no_history_desc: 'Completed or cancelled consultations stay here.',
    owner_joined: 'Owner joined',
    owner_waiting: 'Owner waiting',
    vet_joined: 'Vet joined',
    vet_waiting: 'Vet waiting',
    note_added: 'Note added',
    profile_title: 'My vet profile',
    profile_desc: 'Update the name, specialties and availability shown in the panel.',
    display_name_label: 'Full name',
    license_no_label: 'License / chamber no',
    specialties_label: 'Specialties',
    specialties_placeholder: 'Example: general consultation, nutrition, behavior',
    bio_label: 'Short bio',
    email_label: 'Email',
    phone_label: 'Phone',
    timezone_label: 'Timezone',
    available_label: 'I am available for requests now',
    save_profile: 'Save Profile',
    profile_saved: 'Profile updated.',
    profile_failed: 'Could not save profile. {error}',
    ...
    password_failed: 'Could not change password. {error}',
    status: {
      requested: 'Requested',
      scheduled: 'Scheduled',
    ...
    hold_status: {
      held: 'Held',
      captured: 'Consultation completed and spent',
      released: 'Refunded'
    }
  },
  common: {
