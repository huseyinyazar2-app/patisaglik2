...
Return JSON:
{
  ...
  vetLive: {
    ...
    home_desc: 'Appointments, room access and vet notes for {name} are managed in this separate area.',
    ...
    vet_panel: 'Vet Panel',
    book_kicker: 'Manual booking MVP',
    book_title: 'Prepare consultation details',
    ...
    room_desc: 'When camera and microphone permission is ready, the Daily room link opens.',
    room_ready: 'Room ready',
    daily_ready: 'Daily room/token information came from the server.',
    ...
    open_room: 'Open Room in New Tab',
    room_failed: 'Could not prepare the room',
    retry_later: 'Check the network connection or permissions and try again.',
    vet_panel_title: 'Manage planned consultations',
    vet_panel_desc: 'This panel belongs to the separate vet-live flow and does not mix with main app forms.',
    note_form_title: 'Consultation outcome note',
    booking_id_label: 'Consultation ID',
    booking_id_placeholder: 'Select a consultation from the list',
