...
const tr = {
  ...
  auth: {
    ...
    email: 'E-posta', phone_or_email: 'Telefon veya e-posta', phone_or_email_placeholder: '+90 5xx xxx xx xx veya e-posta', password: 'Şifre', password_confirm: 'Şifre Tekrar', fullname: 'Ad Soyad',
  ...
  home: {
    ...
    vet_live_entry: 'Veteriner Canlı Görüşme',
...
JSON döndür:
{
  ...
  landing: {
    ...
    kicker: 'Evcil hayvan sağlığında daha düzenli, daha güvenli takip',
    hero_title: 'Panik anında ne yapacağını bil, veterinere eksiksiz bilgiyle git.',
    hero_desc: 'Pet Help; pet sağlık pasaportu, akıllı ön kontrol, kayıt arşivi, paylaşılabilir veteriner raporu ve tedavi sonrası takibi tek sade deneyimde toplar. Teşhis koymaz; doğru bilgiyi toparlamana ve riskli durumda daha hızlı hareket etmene yardım eder.',
    hero_primary: 'Ücretsiz hesap oluştur',
    hero_secondary: 'Nasıl çalışır?',
    ...
    preview_meta: 'Sağlık geçmişi · ön kontrol · takip',
    ...
    vet_guidance_ready: 'Veterinere hazır özet',
    ...
    story_title: 'Pet sahibinin asıl ihtiyacı teşhis değil; düzen, takip ve doğru zamanda doğru aksiyon.',
    story_desc: 'Kusma, ishal, topallama, deri sorunu veya zehirlenme şüphesi gibi anlarda bilgiler dağılır. Pet Help; belirtileri, geçmişi, medya ve belgeleri tek akışta toplar, veteriner görüşmesine daha hazırlıklı gitmeni sağlar.',
    ...
    features_title: 'Sağlık geçmişi, ön kontrol ve takip aynı yerde.',
    features_desc: 'Pet Help, günlük kayıt tutmayı klinik görüşmeye hazırlanan anlamlı bir sağlık dosyasına dönüştürür. Ücretsiz temel takipten AI destekli rapor akışlarına kadar büyüyebilen bir yapı sunar.',
    features: [
      { title: 'Pet sağlık pasaportu', desc: 'Aşı, parazit, ölçüm, belge, masraf, kronik not ve medya geçmişi tek pet dosyasında düzenli kalır.' },
      { title: 'Akıllı ön kontrol', desc: 'Ana şikayetten başlayıp ilgili sorulara daralan akış, gereksiz soru kalabalığını azaltır.' },
      { title: 'Aciliyet farkındalığı', desc: 'Kırmızı bayrakları ayırır, güvenli sınırları korur ve riskli durumda veteriner desteğine yönlendirir.' },
      { title: 'Veterinere hazır link', desc: 'Şikayet özeti, zaman çizelgesi, medya ve belgeler paylaşılabilir rapor linkinde toparlanır.' },
      { title: 'Tedavi sonrası takip', desc: 'İlaç saati, belirti değişimi, yara kontrolü ve kontrol randevusu aynı planda izlenir.' },
      { title: 'Çoklu pet ve aile kullanımı', desc: 'Birden fazla pet, farklı bakım sorumluları ve izinli paylaşım altyapısı aynı temelde çalışır.' }
    ],
    ...
    audience_title: 'Tek kullanıcıya değil, gerçek bakım düzenine göre kuruldu.',
    ...
    proof: ['Veteriner yerine geçmez', 'Paylaşılabilir rapor linki', '20+ dil altyapısına hazır'],
    metrics: [
      { value: '1 dosya', label: 'Pet sağlık geçmişi' },
      { value: '20+ dil', label: 'Global yayın altyapısı' },
      { value: 'Çoklu pet', label: 'Aile ölçeğinde kullanım' }
    ],
    cta_kicker: 'Başlangıç noktası',
    cta_title: 'Petinin sağlık geçmişi bugün düzenli olursa, zor anlarda konuşmak kolaylaşır.',
  ...
  vetLive: {
    title: 'Veteriner Canlı Görüşme',
    kicker: 'Ayrı veteriner modülü',
    home_title: 'Canlı veteriner danışma akışı',
    home_desc: '{name} için aktif veteriner varsa hemen görüşme talebi oluşturabilirsiniz.',
    book_cta: 'Görüşme Talep Et',
    quick_start_cta: 'Canlı Görüşmeyi Başlat',
    schedule_later_cta: 'İleri Saat İçin Talep Oluştur',
    my_bookings: 'Görüşmelerim',
    quick_title: 'Hızlı canlı görüşme',
    quick_desc: 'Kısa özeti yazın, aktif veterineri seçin ve görüşme odasına geçin. Veteriner tarafı panelden katılır.',
    quick_summary_placeholder: 'Kısaca ne oldu? Örn. Bugün iki kez kustu, iştahı azaldı, halsiz görünüyor.',
    active_now: 'Aktif',
    general_consultation: 'Genel danışma',
    flow_title: 'Akış',
    flow_ai: { title: 'Vaka özeti', desc: 'Kullanıcı şikayetini ve kırmızı bayrakları hazırlar.' },
    flow_booking: { title: 'Randevu', desc: 'Onaylı veteriner ve saat ayrı vet tablolarında tutulur.' },
    flow_room: { title: 'Oda', desc: 'Daily oda/token işi yalnızca vet-live API tarafından yönetilir.' },
    flow_note: { title: 'Not', desc: 'Veteriner sonucu ayrı not olarak kaydedilir ve sağlık arşivine işlenir.' },
    recent_title: 'Son görüşmeler',
    vet_panel: 'Veteriner Paneli',
    book_kicker: 'İleri saat talebi',
    book_title: 'Görüşme talebi oluştur',
    book_desc: '{name} için kısa vaka özetini yaz ve uygun veterineri seç.',
    vet_label: 'Veteriner',
    first_available_vet: 'İlk uygun veteriner / talep havuzu',
    no_active_vets: 'Şu an aktif veteriner yok; talep havuza alınabilir.',
    schedule_label: 'Randevu zamanı',
    case_summary_label: 'Vaka özeti',
    case_summary_placeholder: 'Belirti, süre, iştah, davranış ve varsa ön kontrol sonucunu yaz.',
    red_flags_label: 'Kırmızı bayraklar',
    red_flags_placeholder: 'Her satıra bir risk yaz. Örn: nefes darlığı, sürekli kusma.',
    disclaimer: 'Bu alan tanı/tedavi yerine uzaktan danışma ve yönlendirme akışıdır. Acil durumda klinik bekletilmez.',
    duration_warning: 'Görüşme süresi 15 dakikadır. 15 dakikayı aşan durumlarda ileride ek kredi düşebilir; şu an ek kredi alınmaz.',
    legal_consent_label: 'Görüşme başlamadan önce 8 kredinin bloke edileceğini, görüşme başlarsa iptal/iade olmayacağını ve bu hizmetin acil klinik muayene yerine geçmediğini kabul ediyorum.',
    legal_consent_required: 'Randevu oluşturmak için kredi ve danışma şartlarını onaylamanız gerekir.',
    create_booking: 'Görüşme Talebi Oluştur',
    not_scheduled: 'Zaman seçilmedi',
    default_vet: 'Onaylı veteriner',
    active_pet: 'Aktif pet',
    empty_case_summary: 'Vaka özeti yazılmadı.',
    mark_paid: 'Manuel ödeme onayı',
    credit_hold_label: 'Kredi durumu',
    cancel_booking: 'Görüşmeyi İptal Et ve Krediyi İade Et',
    join_room: 'Canlı Görüşmeyi Başlat',
    start_consultation: 'Canlı Görüşmeyi Başlat',
    note_title: 'Veteriner notu',
    no_note: 'Henüz veteriner notu girilmedi.',
    room_kicker: 'Daily Prebuilt',
    room_title: 'Görüşme odası',
    room_desc: 'Kamera ve mikrofon izni verildiğinde görüşme ekranı burada açılır.',
    room_ready: 'Görüşme hazır',
    daily_ready: 'Görüşme bağlantısı hazır. Veteriner de katıldığında konuşmaya başlayabilirsiniz.',
    local_room_notice: 'Daily API anahtarı yok; pilot için local/mock oda bağlantısı gösteriliyor.',
    permission_denied: 'Kamera veya mikrofon izni reddedildi',
    open_room: 'Görüşmeyi Yeni Sekmede Aç',
    room_failed: 'Görüşme bağlantısı hazırlanamadı',
    retry_later: 'Ağ bağlantısını veya izinleri kontrol edip tekrar deneyin.',
    vet_panel_title: 'Bekleyen canlı görüşmeler',
    vet_panel_desc: 'Kullanıcı taleplerini buradan üstlenebilir, görüşmeye katılabilir ve görüşme sonu notunu yazabilirsiniz.',
    note_form_title: 'Görüşme sonu kaydı',
    note_form_desc: 'Görüşmeden sonra bu not zorunludur. Petin sağlık özetine kaydedilir.',
    booking_id_label: 'Seçilen görüşme',
    booking_id_placeholder: 'Üstteki listeden görüşme seçin',
    note_summary_label: 'Genel değerlendirme',
    note_summary_placeholder: 'Görüşmede ne konuşuldu, genel durum nasıl, ne önerildi?',
    next_step_label: 'Önerilen sonraki adım',
    next_step_placeholder: 'Örn. 24 saat izle, klinik muayene, kontrol görüşmesi...',
    clinic_visit_recommended: 'Klinik muayene önerilir',
    save_note: 'Notu Kaydet',
    health_record_title: 'Veteriner canlı görüşme',
    no_bookings: 'Görüşme yok',
    no_bookings_desc: 'İlk canlı veteriner randevusunu bu alandan oluşturabilirsiniz.',
    no_queue: 'Bekleyen görüşme yok',
    no_queue_desc: 'Randevu oluşunca veteriner panelinde listelenir.',
    load_failed: 'Görüşme bilgileri getirilemedi.',
    lookup_ready: 'Onaylı veterinerler hazır.',
    lookup_failed: 'Veteriner listesi getirilemedi.',
    quote_text: '{duration} dakika · {price}',
    credit_price: '{count} kredi',
    quote_failed: 'Fiyat bilgisi getirilemedi.',
    summary_required: 'Vaka özeti zorunlu.',
    booking_created: 'Görüşme randevusu oluşturuldu.',
    booking_failed: 'Randevu oluşturulamadı. {error}',
    booking_not_found: 'Görüşme bulunamadı.',
    payment_marked: 'Ödeme manuel olarak onaylandı.',
    payment_failed: 'Ödeme onaylanamadı.',
    insufficient_credits: 'Bu görüşme için yeterli kredi yok.',
    booking_cancelled: 'Görüşme iptal edildi, bloke kredi iade edildi.',
    cancel_failed: 'İptal/iade tamamlanamadı. {error}',
    owner_survey_title: 'Veteriner değerlendirmesi',
    vet_survey_title: 'Kullanıcı görüşme değerlendirmesi',
    survey_rating_label: 'Puan',
    owner_survey_feedback: 'Veterinerden memnun kaldınız mı?',
    vet_survey_feedback: 'Kullanıcı görüşmeye uygun ve anlaşılır katıldı mı?',
    save_survey: 'Anketi Kaydet',
    survey_saved: 'Anket kaydedildi.',
    survey_failed: 'Anket kaydedilemedi. {error}',
    note_required: 'Görüşme ID ve not zorunlu.',
    note_saved: 'Veteriner notu kaydedildi.',
    note_failed: 'Not kaydedilemedi. {error}',
    pool_request: 'Havuz talebi',
    pool_request_desc: 'Yine de talep oluşturabilirsiniz; aktif veteriner panele düştüğünde üstlenir.',
    claim_booking: 'Talebi Bana Ata',
    claim_saved: 'Talep veteriner hesabınıza alındı.',
    claim_failed: 'Talep üstlenilemedi. {error}',
    select_for_note: 'Bu Görüşmeye Not Yaz',
    open_detail: 'Görüşme Bilgileri',
    tab_active: 'Aktif',
    tab_scheduled: 'Randevulu',
    tab_history: 'Geçmiş',
    tab_profile: 'Profil',
    refresh: 'Yenile',
    active_requests_title: 'Aktif canlı talepler',
    scheduled_requests_title: 'Randevulu talepler',
    history_title: 'Geçmiş görüşmeler',
    no_active_requests: 'Aktif talep yok',
    no_active_requests_desc: 'Hemen başlayacak ya da havuzdaki talepler burada görünür.',
    no_scheduled_requests: 'Randevulu talep yok',
    no_scheduled_requests_desc: 'İleri saatli talepler burada listelenir.',
    no_history: 'Geçmiş görüşme yok',
    no_history_desc: 'Tamamlanan veya iptal edilen görüşmeler burada kalır.',
    owner_joined: 'Kullanıcı katıldı',
    owner_waiting: 'Kullanıcı bekliyor',
    vet_joined: 'Veteriner katıldı',
    vet_waiting: 'Veteriner bekliyor',
    note_added: 'Not var',
    profile_title: 'Veteriner profilim',
    profile_desc: 'Panelde görünen ad, uzmanlık ve müsaitlik bilgisini buradan güncelleyebilirsiniz.',
    display_name_label: 'Ad soyad',
    license_no_label: 'Ruhsat / oda no',
    specialties_label: 'Uzmanlıklar',
    specialties_placeholder: 'Örn. genel danışma, beslenme, davranış',
    bio_label: 'Kısa tanıtım',
    email_label: 'E-posta',
    phone_label: 'Telefon',
    timezone_label: 'Saat dilimi',
    available_label: 'Şu an taleplere açığım',
    save_profile: 'Profili Kaydet',
    profile_saved: 'Profil güncellendi.',
    profile_failed: 'Profil kaydedilemedi. {error}',
    ...
    password_required: 'Mevcut şifre ve yeni şifre zorunlu.',
    password_mismatch: 'Yeni şifreler eşleşmiyor.',
    password_saved: 'Şifre güncellendi.',
    password_failed: 'Şifre değiştirilemedi. {error}',
    status: {
      requested: 'Talep',
      scheduled: 'Planlandı',
      credit_held: 'Kredi Blokeli',
      paid: 'Ödendi',
      live: 'Canlı',
      completed: 'Tamamlandı',
      cancelled: 'İptal',
    ...
    hold_status: {
      held: 'Blokeli',
      captured: 'Görüşme tamamlandı, harcandı',
      released: 'İade edildi'
    }
  },
  common: {
