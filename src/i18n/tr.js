...
JSON döndür:
{
  ...
  vetLive: {
    ...
    home_desc: '{name} için randevu, oda ve veteriner notu bu ayrı alanda yönetilir.',
    ...
    book_kicker: 'Manuel randevu MVP',
    book_title: 'Görüşme bilgilerini hazırla',
    ...
    create_booking: 'Randevu Oluştur',
    ...
    room_desc: 'Kamera ve mikrofon izni hazır olunca Daily oda bağlantısı açılır.',
    room_ready: 'Oda hazır',
    daily_ready: 'Daily oda/token bilgisi server tarafından alındı.',
    ...
    open_room: 'Odayı Yeni Sekmede Aç',
    room_failed: 'Oda hazırlanamadı',
    retry_later: 'Ağ bağlantısını veya izinleri kontrol edip tekrar deneyin.',
    vet_panel_title: 'Planlanan görüşmeleri yönet',
    vet_panel_desc: 'Bu panel ayrı vet-live akışı içindir; ana uygulama formlarına karışmaz.',
    note_form_title: 'Görüşme sonucu notu',
    booking_id_label: 'Görüşme ID',
    booking_id_placeholder: 'Listeden bir görüşme seç',
