...
- `onboarding-report.jpg`: veterinere hazir rapor slayti
- `auth-secure.jpg`: giris ekrani
- `auth-register.jpg`: hesap olusturma ekrani

Bir gorseli degistirmek icin ayni dosya adiyla bu klasore yeni gorseli koymak yeterlidir.
